...
async def client_status(msg: Message):
    ...
    # CHANGED: same bug as "🔗 Моя ссылка" — previously this just printed the
    # (already past) expiry date with no indication access was actually
    # gone, and no prompt to pay. Now shows the same expired-state message.
